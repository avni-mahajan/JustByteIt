...
const Header = () => {
    ...
    <div className="flex justify-around shadow-md relative">
      ...
      <div className="flex">
        <ul className="flex m-2">
          ...
          <li className="py-3 px-5 hover:text-pink-400 hover:cursor-pointer my-2 font-bold"><Link to="/about">About</Link></li>
          <li className="py-3 px-5 hover:text-pink-400 hover:cursor-pointer my-2 font-bold">
              ...
              <div className="relative">
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-lg p-2">
                    <p className="text-center text-gray-700 font-bold">{user}</p>
                    <button
  ...
  <div className="fixed inset-0 flex justify-center items-center bg-black/50 z-50">
    <div className="bg-white p-8 rounded-2xl shadow-2xl w-96 relative">
      <h2 className="text-2xl font-bold text-center text-pink-600">Welcome!</h2>
      ...
      <div className="text-center mt-4">
        ...
        <p className="text-sm mt-2">
          ...
          <button className="text-pink-500 font-bold hover:underline">Sign Up</button>
        </p>
      </div>
      <button
